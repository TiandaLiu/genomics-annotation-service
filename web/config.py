...
class Config(object):  
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:tliu77_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:tliu77_job_results"
  AWS_SNS_JOB_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:tliu77_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "tliu77_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "tliu77@ucmpcs.org"
